...
def transform_features(data: DataFrame) -> DataFrame:
    ...
    vector_assembler = VectorAssembler(inputCols=raw_feature_columns, outputCol="features")
...
def split_data(transformed_data: DataFrame, example_test_data_ratio: float) -> Dict[str, Any]:
